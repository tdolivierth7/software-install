#!/bin/bash
# Userdata script to Install Prometheus on Ubuntu 24.04 VM
# Hardware requirements: Ubuntu 24.04 with minimum t2.micro type instance & port 9090 allowed on the security groups
